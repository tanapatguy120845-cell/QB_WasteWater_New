...
namespace PGroup
{
    public class NewPipeBuilder : MonoBehaviour
    {
        ...
        public void BuildPipeBatch(List<List<Vector2>> paths)
        {
            ...
            groupObj.transform.parent = GameplayController.instance.pool;
        ...
        private void UpdatePipeVisualAt(Vector2 pos)
        {
            ...
            if (prefab != null)
            {
                ...
                {
                    GameplayController.instance.GetPipeConnection(currentBatchContainer, false);
                ...
                {
                    GameplayController.instance.GetPipeConnection(currentBatchContainer, true);
